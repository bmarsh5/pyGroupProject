...
Description:
            From a pile of balls, a player or the computer may take up to
            half of the balls on each turn.  The player who takes the last
            balls loses.
    ...
    while ballCount >= 2 :
        if whoseTurn == 0 :
            ...
            if mode == 0 or ballCount == 3 or ballCount == 7 or ballCount == 15 or ballCount == 31 or ballCount == 63 :
                print("Computer is playing in dumb mode.")
                ballCount = computerDumbMode(ballCount)
                print("The pile size is now",ballCount, "balls.\n")
                whoseTurn = 1
            else :
                print("Computer is playing in smart mode.")
...
def ballCountFunction() :
        ...
        print("Ball count is ",result,"balls.")
        return result
...
def computerMode() :
    ...
    print("Computer mode =", computerMode)
    return computerMode
...
def computerDumbMode(ballCount): 
    ...
    print("The computer takes away", dumbBallCount,"balls.")    #Prints the random value to be subtracted from the pile    
    return result     
...
def playerTurn (ballCount):
    ...
    while not playerTurn:
        ...
        print("How many balls would you like to remove?  Half of the pile size is: ", allowableChoice,"balls.")
